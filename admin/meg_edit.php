    ...
    <div class="row">
      ...
      <form class="form-horizontal" method="post">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="请输入留言名称" name="name" value="<?php echo $dataselect["meg_name"]; ?>">
          </div>
        </div>
      <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">留言内容</label>
          <div class="col-sm-10">
            <textarea name="content" class="form-control"><?php echo $dataselect["meg_content"]; ?></textarea>
          </div>
        </div>
        <div class="form-group">
